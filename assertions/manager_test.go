...
// 	bobPostState, err := bobStateManager.ExecutionStateAfterPreviousState(ctx, 1, genesisCreationInfo.AfterState.GlobalState.Bytes32Vals[0], genesisCreationInfo.InboxMaxCount.Uint64())
// 	require.NoError(t, err)
