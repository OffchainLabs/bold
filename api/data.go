...
// TODO: Move all of these things into a more appropriate place.
...
type Edge struct {
	...
	ClaimID             common.Hash            `json:"claimId,omitempty"` // TODO: How does this work with Option[]?
	HasChildren         bool                   `json:"hasChildren"`
	LowerChildID        common.Hash            `json:"lowerChildId,omitempty"`
	UpperChildID        common.Hash            `json:"upperChildId,omitempty"`
	MiniStaker          common.Address         `json:"miniStaker,omitempty"` // TODO: How does this work with Option[]?
