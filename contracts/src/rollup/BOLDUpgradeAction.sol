...
contract BOLDUpgradeAction {
    ...
    address public immutable LOSER_STAKE_ESCROW;
    ...
    constructor(
        ...
        LOSER_STAKE_ESCROW = contracts.loserStakeEscrow;
    ...
    function createConfig() private view returns (Config memory) {
        ...
        return Config({
            ...
            loserStakeEscrow: LOSER_STAKE_ESCROW,
            chainId: CHAIN_ID,
    ...
    function perform(address[] memory validators) external {
        ...
        challengeManager.initialize({
            ...
            _excessStakeReceiver: LOSER_STAKE_ESCROW,
