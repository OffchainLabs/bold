...
contract BOLDUpgradeAction {
    ...
    uint256 public immutable INITIAL_MINI_STAKE_AMOUNT;
    uint256 public immutable MINI_STAKE_SLOPE;
    ...
    constructor(
        ...
        INITIAL_MINI_STAKE_AMOUNT = settings.initialMiniStakeAmt;
        MINI_STAKE_SLOPE = settings.miniStakeSlope;
    ...
    function createConfig() private view returns (Config memory) {
        ...
        return Config({
            ...
            initialMiniStakeValue: INITIAL_MINI_STAKE_AMOUNT,
            miniStakeSlope: MINI_STAKE_SLOPE,
    ...
    function perform(address[] memory validators) external {
        ...
        challengeManager.initialize({
            ...
            _initialStakeAmount: INITIAL_MINI_STAKE_AMOUNT,
            _stakeAmountSlope: MINI_STAKE_SLOPE
        });
