...
contract ChallengeEdgeLibAccess {
    ...
    function newLayerZeroEdge(
        ...
        return ChallengeEdgeLib.newLayerZeroEdge(
            originId, startHistoryRoot, startHeight, endHistoryRoot, endHeight, claimId, staker, stakeAmount, level
        );
    }
...
contract ChallengeEdgeLibTest is Test {
    ...
    function testNewLayerZeroEdge() public {
        ...
        uint256 stakeAmount = 234567890;
        ChallengeEdgeLibAccess access = new ChallengeEdgeLibAccess();
        ChallengeEdge memory e =
            access.newLayerZeroEdge(originId, startRoot, 10, endRoot, 15, claimId, staker, stakeAmount, NUM_BIGSTEP_LEVEL + 1);
        ...
        assertEq(e.stakeAmount, stakeAmount, "Stake Amount");
    ...
    function testNewLayerZeroEdgeZeroStaker() public {
        ...
        access.newLayerZeroEdge(originId, startRoot, 10, endRoot, 15, claimId, address(0), 20, NUM_BIGSTEP_LEVEL + 1);
    }
    ...
    function testNewLayerZeroEdgeZeroClaimId() public {
        ...
        access.newLayerZeroEdge(originId, startRoot, 10, endRoot, 15, 0, staker, 20, NUM_BIGSTEP_LEVEL + 1);
    }
    ...
    function testEdgeExists() public {
        ...
        ChallengeEdge memory layerZeroEdge =
            layerZero.newLayerZeroEdge(originId, startRoot, 10, endRoot, 15, claimId, staker, 20, NUM_BIGSTEP_LEVEL + 1);
    ...
    function testLength() public {
        ...
        ChallengeEdge memory layerZeroEdge = ChallengeEdgeLib.newLayerZeroEdge(
            originId, startRoot, 10, endRoot, 15, claimId, staker, 20, NUM_BIGSTEP_LEVEL + 1
        );
        layerZero.setChallengeEdge(layerZeroEdge);
