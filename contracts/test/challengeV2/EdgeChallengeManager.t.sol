...
contract EdgeChallengeManagerTest is Test {
    ...
    uint256 miniStakeSlope = 0.1 ether;
    ...
    function testDeployInit() public {
        ...
        ecm.initialize(
            assertionChain, 0, osp, 2 ** 5, 2 ** 5, 2 ** 5, erc20, excessStakeReceiver, NUM_BIGSTEP_LEVEL, miniStakeVal, miniStakeSlope
        );
        ...
        returns (EdgeInitData memory, bytes32[] memory, bytes32[] memory, bytes32)
    {
        ...
        // should be initialStakeAmount because no rivals
        assertEq(beforeBalance - afterBalance, ei.challengeManager.initialStakeAmount(), "Staked");
    ...
    function testCanRefundStake() external {
        ...
        // todo: should this be initial amount?
        assertEq(afterBalance - beforeBalance, ei.challengeManager.initialStakeAmount(), "Stake refunded");
    }
