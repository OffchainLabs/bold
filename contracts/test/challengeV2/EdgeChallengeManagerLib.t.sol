...
contract EdgeChallengeManagerLibAccess {
    ...
    function getPrevAssertionHash(bytes32 edgeId, uint8 numBigStepLevel) public view returns (bytes32) {
        return store.getPrevAssertionHash(edgeId, numBigStepLevel);
    }
