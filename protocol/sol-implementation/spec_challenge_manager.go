...
func (e *SpecEdge) TimeUnrivaled(ctx context.Context) (uint64, error) {
	timer, err := e.manager.caller.TimeUnrivaled(e.manager.callOpts, e.id)
	if err != nil {
		return 0, err
	}
...
func (e *SpecEdge) HasRival(ctx context.Context) (bool, error) {
	return e.manager.caller.HasRival(e.manager.callOpts, e.id)
}
...
func (e *SpecEdge) HasLengthOneRival(ctx context.Context) (bool, error) {
	ok, err := e.manager.caller.HasLengthOneRival(e.manager.callOpts, e.id)
	if err != nil {
		errS := err.Error()
		switch {
